...
Inherits iosGestures.baseGestureRecognizer
	...
	#tag DelegateDeclaration, Flags = &h0
		Delegate Sub longPressBeginsDelegate(recognizer as iosGestures . longPressGesture, pos as xojo . Core . Point, eventInfo as iosGestures . gestureEventInfo)
	#tag EndDelegateDeclaration

	#tag DelegateDeclaration, Flags = &h0
		Delegate Sub longPressChangedDelegate(recognizer as iosGestures . longPressGesture, pos as xojo . Core . Point, eventInfo as iosGestures . gestureEventInfo)
	#tag EndDelegateDeclaration

	#tag DelegateDeclaration, Flags = &h0
		Delegate Sub longPressEndsDelegate(recognizer as iosGestures . longPressGesture, pos as xojo . Core . Point, eventInfo as iosGestures . gestureEventInfo)
	#tag EndDelegateDeclaration


	#tag Hook, Flags = &h0
		Event LongPressBegins(pos as xojo.Core.Point, eventInfo as iosGestures.gestureEventInfo)
	#tag EndHook

	#tag Hook, Flags = &h0
		Event LongPressChanged(pos as xojo.Core.Point, eventInfo as iosGestures.gestureEventInfo)
	#tag EndHook

	#tag Hook, Flags = &h0
		Event LongPressEnds(pos as xojo.Core.Point, eventInfo as iosGestures.gestureEventInfo)
	#tag EndHook
