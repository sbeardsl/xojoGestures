...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  swipeLeftGesture1.Attach( SwipeView.Handle )
		  swipeRightGesture1.Attach( SwipeView.Handle )
		  swipeUpGesture1.Attach( SwipeView.Handle )
		  swipeDownGesture1.Attach( SwipeView.Handle )
		End Sub
	#tag EndEvent


	#tag Property, Flags = &h0
		m_bSwipeLeft As Boolean
	#tag EndProperty
